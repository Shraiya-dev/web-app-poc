					...
					<div>
						<div>
							...
							<p>
								...
								our products that appear at the store. We cannot guarantee that your computer
							...
							<p>
								...
								same credit card, and/or orders that use the same billing and/or shipping address. In
							...
							<p>
								...
								and discretion and you should ensure that you are familiar with and approve of the terms
								on which tools are provided by the relevant third-party provider(s).
							</p>
							<p>
							...
							<p>
								...
								copy, publish, distribute, translate and otherwise use in any medium any comments that
								you forward to us. We are and shall be under no obligation (1) to maintain any comments
								in confidence; (2) to pay compensation for any comments; or (3) to respond to any
								comments.
							</p>
							<p>
							...
							<p>
								...
								false e-mail address, pretend to be someone other than yourself, or otherwise mislead us
								or third-parties as to the origin of any comments. You are solely responsible for any
							...
							<p>
								...
								risk. The service and all products and services delivered to you through the service are
							...
							<p>
								In no case shall <strong>Hard Hat Technologies Pvt Ltd</strong>, our directors,
								officers, employees, affiliates, agents, contractors, interns, suppliers, service
								...
								limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or
								...
								the service, even if advised of their possibility. Because some states or jurisdictions
							...
							<p>
								...
								<strong>Hard Hat Technologies Pvt Ltd</strong> and our parent, subsidiaries, affiliates,
							...
							<p>
								...
								be governed by and construed in accordance with the laws of India and jurisdiction of
								Jaipur, Rajasthan
							</p>
							...
							<p>
								...
								<strong>
									<a target='_blank' rel='noopener noreferrer' href='mailto:help@projecthero.in'>
										help@projecthero.in
									</a>
								</strong>
							</p>
